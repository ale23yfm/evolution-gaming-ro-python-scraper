...
```bash
git clone git@github.com:peviitor-scrapers/evolution-gaming-ro-python-scraper.git
cd evolution-gaming-ro-python-scraper
...
[peviitor-scrapers/evolution-gaming-ro-python-scraper/issues](https://github.com/peviitor-scrapers/evolution-gaming-ro-python-scraper/issues).
